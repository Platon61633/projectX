...
const MMO = () => {
    ...
    const Teachers = [
        {img: first, full_name: 'Пименов Марк', years: '18', university: 'МГУ им. М.В. Ломоносов', achievements: 'Трёхкратный победитель региона ВсОШ, призёр заключительного этапа ВсОШ, победитель устного тура турнира Городов и серебряный медалист IZHO' },
        {img: second, full_name: 'Аверин Михаил ', years: '18', university: 'МГУ им. М.В. Ломоносов', achievements: 'Победитель перечневых олимпиад по математике таких как ММО, Устный Турнир Городов, Высшая Проба, Курчатов, Физтех - все за 11 класс. Трехкратный участник заключительного этапа ВСОШ по математике и двухкратный участник ВСОШ по экономике' },
        {img: third, full_name: 'Демидкин Максим', years: '18', university: 'МГУ им. М.В. Ломоносов', achievements: 'Трёхкратный победитель региона ВСОШ по математике, призер заключительного этапа ВСОШ по математике, победитель ММО 11 класс, победитель устного турнира городов' },
