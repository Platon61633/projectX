    ...
    return (
        <div className={styles.MMO}>
            <div className={styles.title_main}>
                Интенсивная подготовка к Московской математической олимпиаде (ММО)
            </div>
            ...
            <section className={styles.info} style={{ marginBottom: 100 }}>
                ...
                {FourReason ? (
                    <p className={styles.text}>
                        • Экспертность. Наши преподаватели - это победители и
                        призеры Всероссийской олимпиады школьников, которые сами
                        прошли через все трудности при подготовке и написании
                        олимпиад. Добавьте к этому опыт преподавания в школах —
                        и вы получите наставников, которые умеют передать свой
                        ценный опыт детям.
                        <br /> <br />
                        • Авторская программа. Это не пересказ учебников, а
                        выжимка реально работающих методов, которые приносят
                        дипломы. Мы знаем, какие темы падают на ММО чаще всего,
                        и бьем точно в цель.
                        <br /> <br />
