                ...
                <section className={styles.info}>
                    ...
                    {ShowProgram ? (
                        <p className={styles.text}>
                            ...
                            <br />
                            <br />
                            В зависимости от класса темы могут немного отличаться
                            по уровню сложности и наполнению, но логика курса
                            остаётся общей и написана ниже👇
                            <br />
                            <br />
                            1. Теория чисел
                            <br />
                            ...
                            <br />
                            Работа
                            с выражениями, тождествами, дробями, процентами и
                            неравенствами. Формирует умение преобразовывать
                            формулы, оценивать выражения и уверенно владеть
                            буквенной записью.
                            <br />
                            <br />
                            3. Уравнения, системы и
                            многочлены
                            <br />
                            <br />
                            Линейные и нелинейные уравнения, системы,
                            работа с многочленами, разложения и тождества —
                            учимся переводить текст задачи в формулы и работать
                            с ними уверенно. 
                            <br />
                            <br />
                            4. Комбинаторика
                            ...
                            <br />
                            Подсчёт вариантов,
                            перестановки, размещения, принцип Дирихле, графы и
                            раскраски. Учит системно перебирать случаи и
                            доказывать существование нужной конфигурации. 
                            <br />
                            <br />
                            5.
                            Планиметрия
                            <br />
                            <br />
                            Геометрия на плоскости: углы,
                            треугольники, окружности, площади, подобие и
                            конфигурации. Развивает пространственное мышление и
                            строгость доказательств. 
                            <br />
                            <br />
                            6.
                            Стереометрия(Геометрия-2)
                            <br />
                            <br />
                            Задачи о пространственных
                            фигурах: объёмы, сечения, развертки, расположение
                            объектов в пространстве. Тренирует трёхмерное
                            мышление и аккуратность рассуждений. 
                            <br />
                            <br />7. Логика и
                            стратегии
                            <br />
                            <br />
                            Задачи на анализ утверждений, правду и
                            ложь, а также игровые стратегии. Формирует умение
                            рассуждать последовательно и находить выигрышные
                            идеи. 
                            <br />
                            <br />
                            8. Инварианты
                            ...
                            процессами: сохранение величины, нечётность,
                            невозможность. Позволяет доказывать, что некоторый
                            результат достижим или невозможен. 
                            <br />
                            <br />
                            9. Оценки и
                            экстремумы
                            <br />
                            <br />
                            Поиск максимума и минимума, оценка сверху
                            и снизу, принцип крайнего элемента. Учит находить
                            границы возможного и работать с неравенствами. 
                            <br />
                            <br />10.
                            Конструктивные методы
                            <br />
                            <br />
                            Задачи на построение примеров,
                            разрезания, разбиения и доказательство
                            существования. Развивает творческий подход и умение
                            создавать математические объекты.
                        </p>
                    ) : null}
                </section>
                <section className={styles.info}>
