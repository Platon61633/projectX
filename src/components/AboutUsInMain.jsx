            ...
            <div className={styles.block_1}>
                <div className={styles.text}>
                    ...
                    <p>
                        ...
                        инструментом для развития интеллекта, а не просто
                        школьным предметом. Мы создаём среду, в которой дети
                        учатся думать нестандартно, анализировать и получать
                        удовольствие от поиска решений. Наша главная цель — не
                        подготовка к конкретному экзамену или олимпиаде, а
                        воспитание по-настоящему думающих людей. Мы верим, что
